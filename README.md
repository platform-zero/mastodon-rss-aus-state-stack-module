# Mastodon RSS Australia State stack module

Content-only Platform Zero module providing curated Australian public and state media feeds and Mastodon bootstrap follows to `mastodon-rss-publisher`.
